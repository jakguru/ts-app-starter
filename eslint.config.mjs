                ...
                create(context) {
                    return {
                        UnaryExpression(node) {
                            if (node.operator === '!' && node.argument.type === 'Identifier' && node.argument.name === 'window') {
                                context.report({
                                    node,
                                    message: 'Avoid using `!window`. Use `typeof window === "undefined"` instead.',
                                    fix(fixer) {
...
export default [
    {
        ignores: ["node_modules", "docs/.vitepress/cache", "docs/.vitepress/dist", "dist", "docs/public/repl", ".gitlab-ci-local"],
    },
    {
        files: ["**/*.ts", "**/*.tsx", "**/*.mts"],
        languageOptions: {
